...
class Unittest_kmeans:
    ...
    def unit_test(self):
        ...
        assert (obj.get_cluster_data(data)).shape == (
        200, 4), f"shape (200, 4) is expected, got: {(obj.get_cluster_data(data)).shape}"
        print("Shape of cluster dataframe is as expected")
        assert (obj.get_outliers(data)).shape == (
        8, 4), f"shape (8, 4) is expected, got: {(obj.get_outliers(data)).shape}"
        ...
        dt = {
            ...
            "Y_values": [-7.196390063, -6.168104013, -4.693934183, -7.333215341, -5.420551724, -6.900783848,
                         -7.308746131,
                         -6.962860496, -6.113208564, -5.694848859, -6.264615182, -6.186441238, -7.526537881,
                         -7.363255714,
                         -5.863770417, -8.505738965, -6.744344904, -6.161557739, -5.279224427, -5.225046954,
                         -5.85764687,
                         -3.599815178, -5.953636352, -6.422813702, -6.685124968, -7.454110175, -4.979516312,
                         -7.391182901,
                         -4.502911705, -3.727736758, -4.900436652, -7.559859092, -9.648850992, -5.668539418,
                         -7.704721065,
                         -6.49423689, -6.511215654, -8.238000608, -6.876909761, -8.579393695, -6.574297148,
                         -6.591972827,
                         -7.049482539, -4.417786281, -6.289807327, -5.467683036, -8.386040114, -8.561267915,
                         -9.051416929,
                         -6.160346619, -4.819828868],
            "label": [1, 1, 1, 0, 1, 0, 0, 0, 1, 1, 0, 1, 0, 1, 0, 0, 0, 1, 1, 1, 0, 1, 0, 0, 0, 0, 1, 0, 1, 1, 1, 0, 0,
                      1,
                      0,
